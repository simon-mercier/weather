...
const weatherType2WidthOfClouds = new Map<WeatherType, string>([
    ...
    [WeatherType.HAZE, "70vmax"],
    [WeatherType.SMOKE, "70vmax"],
...
const CloudAnimation = () => {
    ...
    const periodOfDay: PeriodOfDay = useContext(PeriodOfDayContext);
